        ...
        <main className='search-page'>
            ...
            <form className='search-page-form'>
                <div className='search-page-form-inputs'>
                    ...
                    <input className='search-page-form-input' id='search-page-form-inn-input' placeholder='10 цифр' onBlur={() => !validateINN(INN) ? setINNError(true) : setINNError(false)} value={INN} onChange={event => setINN(event.target.value)} style={INNError ? { border: '1px solid #ff5959' } : { border: '1px solid #c7c7c7' }} /><br />
